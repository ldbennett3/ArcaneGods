...
public class TranslationTable extends BlockBase implements ITileEntityProvider {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (!worldIn.isRemote) {
			playerIn.openGui(Main.instance, Reference.GUI_TRANSLATION_TABLE, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
	...
	public static void setState(boolean active, World worldIn, BlockPos pos) {
		...
		worldIn.setBlockState(pos, ModBlocks.TRANSLATION_TABLE.getDefaultState().withProperty(FACING, state.getValue(FACING)), 1 | 2);
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		TileEntityTranslationTable tileEntity = (TileEntityTranslationTable)worldIn.getTileEntity(pos);
