...
public class BrickFurnace extends BlockBase implements ITileEntityProvider {
	...
	public BrickFurnace(String name) {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (!worldIn.isRemote) {
			playerIn.openGui(Main.instance, Reference.GUI_BRICK_FURNACE, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
	...
	public static void setState(boolean active, World worldIn, BlockPos pos) {
		...
		if (active) {
			worldIn.setBlockState(pos, ModBlocks.BRICK_FURNACE.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(BURNING, true), 1 | 2);
		} else {
			worldIn.setBlockState(pos, ModBlocks.BRICK_FURNACE.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(BURNING, false), 1 | 2);
		}
    ...
    {
        if (TileEntityBrickFurnace.isBurning(((TileEntityBrickFurnace)worldIn.getTileEntity(pos))))
        {
