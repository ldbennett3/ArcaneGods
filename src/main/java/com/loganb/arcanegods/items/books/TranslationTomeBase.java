...
public class TranslationTomeBase extends ItemBase implements IHasModel {
	...
	private String messageText = "View this tome in your inventory for more information.";
	 ...
	 */
	public TranslationTomeBase(String name, CreativeTabs tab, Reference.BOOK_LANGUAGE language) {
		super(name, tab);	
		setPages();
		setImages();
		...
		toolTips = new String[]{ 
			TextFormatting.BOLD + "This translation tome seems to hold the secrets to a language.",
